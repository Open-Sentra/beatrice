...
libbeatrice_core.so: /lib64/ld-linux-x86-64.so.2 \
  /lib64/libc.so.6 \
  /lib64/libgcc_s.so.1 \
  /lib64/libm.so.6 \
  /lib64/libmvec.so.1 \
  ...
  /usr/lib64/librte_dispatcher.so \
